...
class RetrieveApplicationTest extends BaseTest {
    ...
    void can_retrieve_an_application_when_authenticated() {
        given()
                ...
                .body("licenses[0].acceptedByCurrentUser", equalTo(true))
                ...
                .body("licenses[1].acceptedByCurrentUser", equalTo(false))
                ...
                .body("licenses[2].acceptedByCurrentUser", equalTo(false))
