...
public class RemsApplicationMapperTest {
    ...
    public void should_map_correctly_complete_rems_application_to_retrieved_application() {
        ...
        assertEquals(
                ...
                retrievedApplication.getDescription());
        assertEquals("APP20240328", retrievedApplication.getGeneratedExternalId());
        assertEquals(OffsetDateTime.parse("2024-03-20T15:18:24.97Z"), retrievedApplication
                .getLastActivity());
        assertEquals(Set.of("researcher"), retrievedApplication.getRoles());
        assertEquals(OffsetDateTime.parse("2022-06-20T15:18:24.97Z"), retrievedApplication
                .getCreatedAt());
        assertEquals(OffsetDateTime.parse("2024-03-20T15:18:24.97Z"), retrievedApplication
                .getModifiedAt());
        assertEquals(RetrievedApplication.StateEnum.APPROVED, retrievedApplication.getState());
        Assertions.assertEquals(new RetrievedApplicationWorkflow(1L, "workflowType"),
                retrievedApplication
                        .getWorkflow());
        Assertions.assertEquals(new RetrievedApplicationApplicant("3P331", "John",
                "john.wattson@gmail.com"),
                retrievedApplication.getApplicant());
        assertEquals(List.of(
                ...
                retrievedApplication.getMembers());

        assertEquals(List.of(
                new RetrievedApplicationDataset(3L, List.of(new Label("fi", "Title in Finnish"),
                        new Label("en", "Title in English")), List.of(new Label("fi",
                                "Url info in Finnish"), new Label("en", "Url info in English"))),
                ...
                retrievedApplication.getDatasets());

        assertEquals(List.of(new RetrievedApplicationForm(4L, "form-access-1", List.of(new Label(
                "en", "External title in English"),
        ...
        assertEquals(List.of("application.command/approve", "application.command/close"),
                retrievedApplication.getPermissions());
        assertEquals(List.of(new RetrievedApplicationEvent("1444", OffsetDateTime.parse(
                "2023-03-20T15:18:24.97Z"), "request")), retrievedApplication.getEvents());
        assertEquals(List.of(new RetrievedApplicationAttachment(14L, "file.pdf", "pdf")),
                retrievedApplication.getAttachments());
    ...
    private Application createApplication() {
        ...
        remsApplication.setApplicationDescription(
                "Research proposal for studying the effects of climate change on biodiversity.");
        ...
        remsApplication.setApplicationWorkflow(new Response10953Workflow(1L, "workflowType", null,
                null, null));
        remsApplication.setApplicationApplicant(new UserWithAttributes("3P331", "John",
                "john.wattson@gmail.com", null, null, null));

        remsApplication.setApplicationMembers(
                new LinkedHashSet<>(
                        List.of(
                                new UserWithAttributes("5YTR", "Mike", "mike.berry@gmail.com", null,
                                        null, null),
                                new UserWithAttributes("NZRWRR", "Elly", "elly.white@outlook.com",
                                        null, null, null))));
        ...
        remsApplication.setApplicationInvitedMembers(new LinkedHashSet(List.of(
                new Response10953InvitedMembers("Kate", "kate.tominay@gmail.com"),
                new Response10953InvitedMembers("Tom", "tom.dylan@gmail.com"))));

        remsApplication.setApplicationPermissions(new LinkedHashSet<>(List.of(
        ...
        remsApplication.setApplicationEvents(List.of(
                new Event("request", OffsetDateTime.parse("2023-03-20T15:18:24.97Z"), null, null,
                        new UserWithAttributes("1444", "Jean", "jean.du@gmail.com", null, null,
                                null))));
        remsApplication.setApplicationAttachments(List.of(new ApplicationAttachment(14L, "file.pdf",
